      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 md:pt-24">
        ...
        <motion.div style={{ opacity: heroOpacity }} className="relative z-20 text-center px-4 max-w-5xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8, duration: 0.6 }}
            ...
            <Link href="/quote" className="btn-shine group flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all duration-200 neon-blue w-full sm:w-auto justify-center">
              Request a Quote
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/services" className="flex items-center gap-2 border border-white/20 hover:border-white/40 text-white font-semibold px-8 py-4 rounded-xl text-lg transition-all duration-200 hover:bg-white/5 w-full sm:w-auto justify-center">
              Explore Services
            </Link>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              From temperature-controlled freight to flatbeds, step decks, containers, and intermodal transport — flexible trucking solutions for businesses moving freight across Canada and the USA.
            </p>
          </ScrollReveal>
              ...
              <ScrollReveal key={s.slug} delay={i * 0.08}>
                <div className="glass-card rounded-2xl p-6 premium-card group h-full flex flex-col border border-white/5 hover:border-blue-500/30 transition-all duration-300">
                  ...
                  <div className="flex gap-2 mt-auto">
                    <Link href={`/services/${s.slug}`} className="flex-1 text-center text-sm border border-white/10 hover:border-blue-500/40 text-slate-300 hover:text-white py-2 rounded-lg transition-all duration-200">
                      View Details
                    </Link>
                    <Link href={`/quote?service=${s.slug}`} className="flex-1 text-center text-sm bg-blue-600/20 hover:bg-blue-600 text-blue-400 hover:text-white py-2 rounded-lg transition-all duration-200">
                      Get Quote
                    </Link>
                  </div>
                </div>
          ...
          <ScrollReveal className="text-center mt-12">
            <Link href="/services" className="btn-shine inline-flex items-center gap-2 border border-blue-500/40 hover:border-blue-500 text-blue-400 hover:text-white font-semibold px-8 py-3 rounded-xl transition-all duration-200">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <Link href="/quote" className="btn-shine inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-400 text-white font-bold px-6 py-3 rounded-xl transition-all duration-200">
      ...
      <section className="py-24 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal className="text-center mb-16">
            ...
            <h2 className="heading-lg text-white mt-3">Reliable Trucking. Strong Communication.<br />Professional Service.</h2>
          </ScrollReveal>
              ...
              {steps.map((step, i) => (
                <ScrollReveal key={step.num} delay={i * 0.1}>
                  <div className="relative text-center">
                    <div className="w-16 h-16 glass-card border-2 border-blue-500/40 rounded-2xl flex items-center justify-center mx-auto mb-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <ScrollReveal>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/quote" className="btn-shine flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold px-10 py-4 rounded-xl text-lg transition-all duration-200 neon-blue">
                Request a Quote <ArrowRight className="w-5 h-5" />
              </Link>
              <Link href="/contact" className="flex items-center justify-center gap-2 border border-white/20 hover:border-white/40 text-white font-semibold px-10 py-4 rounded-xl text-lg transition-all duration-200 hover:bg-white/5">
                Contact Us
              </Link>
            </div>
          </ScrollReveal>
